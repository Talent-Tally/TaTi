...
export const HOME_LOCALE: Record<HomeLocaleKey, HomeCopy> = {
  fr: {
    ...
    guideTiles: [
      { icon: "intro", title: "Introduction", sub: "Vision produit & architecture", href: GUIDE_PATHS.intro },
      { icon: "quick", title: "Démarrage rapide", sub: "Docker Compose & premier lancement", href: GUIDE_PATHS.quick },
      { icon: "config", title: "Configuration", sub: "Variables `.env` expliquées", href: GUIDE_PATHS.config },
      { icon: "mcp", title: "Connecteurs MCP", sub: "Ports, URL et sécurité", href: GUIDE_PATHS.mcp },
      { icon: "architecture", title: "Architecture", sub: "Flux requêtes & services", href: GUIDE_PATHS.arch },
      { icon: "security", title: "Sécurité", sub: "Auth, jetons, garde-fous", href: GUIDE_PATHS.sec },
      { icon: "troubleshooting", title: "Dépannage", sub: "Logs & erreurs fréquentes", href: GUIDE_PATHS.trouble },
  ...
  en: {
    ...
    guideTiles: [
      { icon: "intro", title: "Introduction", sub: "Product vision & architecture", href: GUIDE_PATHS.intro },
      { icon: "quick", title: "Quick start", sub: "Docker Compose & first launch", href: GUIDE_PATHS.quick },
      { icon: "config", title: "Configuration", sub: "`.env` variables explained", href: GUIDE_PATHS.config },
      { icon: "mcp", title: "MCP connectors", sub: "Ports, URLs & security", href: GUIDE_PATHS.mcp },
      { icon: "architecture", title: "Architecture", sub: "Request flows & services", href: GUIDE_PATHS.arch },
      { icon: "security", title: "Security", sub: "Auth, tokens, guardrails", href: GUIDE_PATHS.sec },
      { icon: "troubleshooting", title: "Troubleshooting", sub: "Logs & common errors", href: GUIDE_PATHS.trouble },
    ...
    exploreDesc: "Follow the project on GitHub for announcements and the informal roadmap (issues).",
    exploreCards: [
      {
        title: "Issues",
  ...
  zh: {
    ...
    guideTiles: [
      ...
      { icon: "quick", title: "快速开始", sub: "Docker Compose 与首次启动", href: GUIDE_PATHS.quick },
      ...
      { icon: "troubleshooting", title: "故障排查", sub: "日志与常见错误", href: GUIDE_PATHS.trouble },
    ...
    exploreCards: [
      { title: "Issues", desc: "功能请求与缺陷——提交前先搜索避免重复。", href: "https://github.com/JeffSouop/TaTi/issues" },
      { title: "发行版", desc: "发行说明与构件，用于对齐 `TATI_IMAGE_TAG`。", href: "https://github.com/JeffSouop/TaTi/releases" },
      { title: "CI", desc: "主分支与 PR 的流水线状态。", href: "https://github.com/JeffSouop/TaTi/actions" },
    ],
